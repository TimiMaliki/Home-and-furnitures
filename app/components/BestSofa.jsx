 ...
 useEffect(() => {
  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 w-full h-full mt-20 overflow-hidden'>
         ...
         <div className='lg:w-full lg:h-full text-start px-5 lg:px-20' data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
          ...
          <p className='text-lg text-gray-800 lg:text-gray-500 mb-8'>The Living room is where we spend long hours 
