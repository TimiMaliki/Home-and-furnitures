  ...
  return (
    <div className="w-full h-full grid place-content-center p-20">
      <div className="text-center">
        <h1 className="text-red-600 text-xl font-bold mb-8">Buyers trust us</h1>
        <h2 className="w-96 h-20 font-extrabold text-3xl">
          Our Strategy Is To Provide Our Customers With Quality Products
        </h2>

        <div className="py-20">
          <h3 className="w-96  text-lg mb-8">
